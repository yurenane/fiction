...
<body ontouchstart="">
    ...
    <div class="page__hd">
        <h1 class="page__title">
            <img src="<?php echo WEUI_IMG;?>logo.png" alt="WeUI" height="21px">
        </h1>
        ...
        <ul>
            <li class="">
                <div class="weui-flex js_category">
                    ...
                    <img src="<?php echo WEUI_IMG;?>icon_nav_form.png" alt="">
                </div>
            ...
            <li class="">
                <div class="weui-flex js_category">
                    ...
                    <img src="<?php echo WEUI_IMG;?>icon_nav_layout.png" alt="">
                </div>
            ...
            <li class="">
                <div class="weui-flex js_category">
                    ...
                    <img src="<?php echo WEUI_IMG;?>icon_nav_feedback.png" alt="">
                </div>
            ...
            <li class="">
                <div class="weui-flex js_category">
                    ...
                    <img src="<?php echo WEUI_IMG;?>icon_nav_nav.png" alt="">
                </div>
                <div class="page__category js_categoryInner">
                    <div class="weui-cells page__category-content">
            ...
            <li class="">
                <div class="weui-flex js_category">
                    ...
                    <img src="<?php echo WEUI_IMG;?>icon_nav_search.png" alt="">
                </div>
                <div class="page__category js_categoryInner">
                    <div class="weui-cells page__category-content">
            ...
            <li class="">
                <div class="weui-flex js_item" data-id="layers">
                    ...
                    <img src="<?php echo WEUI_IMG;?>icon_nav_z-index.png" alt="">
                </div>
            </li>
        </ul>
    </div>
...
<div class="page">
    ...
    <div class="page__ft">
        <a href="javascript:home()"><img src="<?php echo WEUI_IMG;?>icon_footer_link.png" /></a>
    </div>
</div>
</script>
    ...
    <div class="page__bd">
        ...
        <div class="weui-cells weui-cells_form">
            ...
            <div class="weui-cell weui-cell_vcode">
                ...
                <div class="weui-cell__ft">
                    <img class="weui-vcode-img" src="<?php echo WEUI_IMG;?>vcode.jpg" />
                </div>
            </div>
        </div>
        ...
        <article class="weui-article">
            ...
            <section>
                ...
                <section>
                    ...
                    <p>
                        <img src="<?php echo WEUI_IMG;?>pic_article.png" alt="">
                        <img src="<?php echo WEUI_IMG;?>pic_article.png" alt="">
                    </p>
                </section>
                <section>
            ...
            <div class="weui-tabbar">
                <a href="javascript:;" class="weui-tabbar__item weui-bar__item_on">
                    <span style="display: inline-block;position: relative;">
                        <img src="<?php echo WEUI_IMG;?>icon_tabbar.png" alt="" class="weui-tabbar__icon">
...
<div class="page">
    ...
    <div class="weui-gallery" style="display: block">
        <span class="weui-gallery__img" style="background-image: url(<?php echo WEUI_IMG;?>pic_article.png);"></span>
                    ...
                    <div class="weui-uploader">
                        ...
                        <div class="weui-uploader__bd">
                            <ul class="weui-uploader__files" id="uploaderFiles">
                                <li class="weui-uploader__file" style="background-image:url(<?php echo WEUI_IMG;?>pic_160.png)"></li>
                                <li class="weui-uploader__file" style="background-image:url(<?php echo WEUI_IMG;?>pic_160.png)"></li>
                                <li class="weui-uploader__file" style="background-image:url(<?php echo WEUI_IMG;?>pic_160.png)"></li>
                                <li class="weui-uploader__file weui-uploader__file_status" style="background-image:url(<?php echo WEUI_IMG;?>pic_160.png)">
    ...
    <div class="weui-grids">
        <a href="javascript:;" class="weui-grid">
            <div class="weui-grid__icon">
                <img src="<?php echo WEUI_IMG;?>icon_tabbar.png" alt="">
            </div>
...
<div class="page">
    ...
    <div class="page__bd page__bd_spacing">
        ...
        ;
            ...
            <script src="<?php echo WEUI_JS; ?>zepto.min.js"></script>
            <script type="text/javascript" src="<?php echo WEUI_JS; ?>jweixin-1.0.0.js"></script>
            <script src="<?php echo WEUI_JS; ?>weui.min.js"></script>
            <script src="<?php echo WEUI_JS; ?>example.js"></script>
